...
int	check_it_otool_64(char *flb, size_t i)
{
	unsigned int	cpu;
	size_t			iter;
...
size_t	len_flb_otool_64(char *flb, size_t stat_size)
{
	size_t				len;
	size_t				res;
	size_t				i;
